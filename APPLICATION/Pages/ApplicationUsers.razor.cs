...
namespace APPLICATION.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<APPLICATION.Models.ApplicationUser> users;
        protected RadzenDataGrid<APPLICATION.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(APPLICATION.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(APPLICATION.Models.ApplicationUser user)
        {
            try
            {
